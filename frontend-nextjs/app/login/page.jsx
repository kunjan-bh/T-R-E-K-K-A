      ...
      <div className="section1">
        ...
        <div className={`${isLogin ? "login-content" : "signup-content"}`}>
          ...
          <div className="social-icon">
            ...
            <Link href="/auth/facebook" // replace with your Facebook OAuth URL
              className="button-login flex items-center gap-2 px-4 py-2 bg-white text-blue-600 border border-blue-600 rounded shadow hover:bg-blue-600 hover:text-white transition"
            >
              <svg
          ...
          <form className="form">
            ...
            <div className={`${isLogin ? "hide" : "flex-row"}`}>
              <div className='check-btn'>
                <input type="checkbox" id="Nation" name="Nation"/>
                <label>I am from Nepal.</label>
              </div>
            </div>
            
            <Link href="/dashboard" className={`${isLogin ? "button-submit" : "hide"}`}>Log In</Link>
            
            <Link href="/dashboard" className={`${isLogin ? "hide" : "button-submit"}`}>Sign Up</Link>
